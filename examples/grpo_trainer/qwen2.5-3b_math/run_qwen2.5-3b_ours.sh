...
SAVE_DIR=/data1/yxfeng/verl/SERA/ours/qwen/Qwen2.5-3B-Instruct/math/math_qwen25_3b_ours_$(date +%Y%m%d_%H%M%S)
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.project_name='verl_ours_qwen2.5_3b_math' \
    trainer.experiment_name='qwen2.5_3b_grpo_lora_math_ours_grpo' \
