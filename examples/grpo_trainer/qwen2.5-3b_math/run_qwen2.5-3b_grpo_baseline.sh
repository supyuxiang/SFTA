#!/bin/bash
# GRPO training script for Qwen2.5-3B on MATH with reference quality scoring
...
model_path=/data1/yxfeng/models/qwen/Qwen2.5-3B-Instruct
save_root=/data1/yxfeng/grpo/baseline/qwen/Qwen2.5-3B-Instruct/math/math_qwen25_3b_grpo_baseline_$(date +%Y%m%d_%H%M%S)
export HF_ENDPOINT="https://hf-mirror.com"
export ACCELERATE_LOG_LEVEL=info

export MODEL_PATH=/data1/yxfeng/models/qwen/Qwen2.5-3B-Instruct
...
lora_alpha=16
lr=1e-6
run_name=qwen2.5_3b_grpo_math_baseline_lora_ep${total_epochs}_lr${lr}
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.project_name='verl_grpo_qwen2.5_3b_math' \
