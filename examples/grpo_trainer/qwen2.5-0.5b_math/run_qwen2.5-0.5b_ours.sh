...
save_root=/data1/yxfeng/grpo/ours/qwen/Qwen2.5-0.5B-Instruct/math/math_qwen25_0d5b_ours_$(date +%Y%m%d_%H%M%S)
...
entropy_coeff=0.001
use_kl_loss=True
run_name=qwen2.5_0.5b_grpo_math_ours_lora_ep${total_epochs}_lr${lr}
...
python3 -m verl.trainer.main_ppo \
    ...
    algorithm.ref_quality_score.steps=5 \
    ...
    trainer.project_name='verl_ours_qwen2.5_0.5b_math' \
