...
model_path=/home/yxfeng/models/qwen/Qwen2.5-0.5B-Instruct
SAVE_DIR=/home/yxfeng/verl/checkpoints/math_qwen25_0p5b_$(date +%Y%m%d_%H%M%S)
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name='qwen2.5_0.5b_grpo_lora_math_ref_quality' \
