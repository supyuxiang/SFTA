#!/bin/bash
# GRPO training script for Qwen2.5-1.5B on MATH with reference quality scoring
...
export MODEL_PATH=/data1/yxfeng/models/qwen/Qwen2.5-Math-1.5B
export DATA_PATH=/data1/yxfeng/data/math

model_path=/data1/yxfeng/models/qwen/Qwen2.5-Math-1.5B
save_root=/data1/yxfeng/grpo/baseline/qwen/Qwen2.5-Math-1.5B/math/math_qwen25_1d5b_grpo_baseline_$(date +%Y%m%d_%H%M%S)
