#!/bin/bash
# GRPO training script with reference model quality scoring for MATH dataset
...
model_path=/home/yxfeng/models/qwen/Qwen2.5-1.5B-Instruct
SAVE_DIR=/home/yxfeng/verl/checkpoints/math_$(date +%Y%m%d_%H%M%S)

python3 -m verl.trainer.main_ppo \
    algorithm.adv_estimator=grpo \
    data.train_files=/home/yxfeng/data/math/train.parquet \
    data.val_files=/home/yxfeng/data/math/test.parquet \
    ...
    trainer.experiment_name='qwen2.5_1.5b_grpo_lora_math_ref_quality' \
