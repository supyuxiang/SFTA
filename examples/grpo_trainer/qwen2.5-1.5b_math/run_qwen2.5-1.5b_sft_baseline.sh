...
model_path=/data1/yxfeng/models/qwen/Qwen2.5-1.5B-Instruct
train_file=/data1/yxfeng/data/math/train.parquet
val_file=/data1/yxfeng/data/math/test.parquet
save_root=/data1/yxfeng/grpo/baseline/qwen/Qwen2.5-1.5B-Instruct/math/math_qwen25_1d5b_sft_baseline_$(date +%Y%m%d_%H%M%S)
train_batch_size=32
...
save_freq=100
test_freq=25
run_name=qwen2.5_1.5b_sft_baseline_math_ep${total_epochs}_lr${learning_rate}
...
python3 -m verl.trainer.fsdp_sft_trainer \
    ...
    trainer.project_name=verl_baseline_sft_qwen2.5_1.5b_math \
