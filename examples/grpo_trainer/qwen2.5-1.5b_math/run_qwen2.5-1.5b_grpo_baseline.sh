...
save_root=/data1/yxfeng/grpo/baseline/qwen/Qwen2.5-1.5B-Instruct/math/math_qwen25_1d5b_grpo_baseline_$(date +%Y%m%d_%H%M%S)
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name='qwen2.5_1.5b_grpo_lora_math_baseline_grpo' \
